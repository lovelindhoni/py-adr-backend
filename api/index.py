...
inverted_sideEffects = {value: key for key, value in sideEffects.items()}
...
def greet():
    if request.method == "POST":
        client = Client("teamhawkeye/adr_model")
        drug1 = drugData[request.json['drug1']]
        drug2 = drugData[request.json['drug2']]
        sideEffect = inverted_sideEffects[request.json['sideEffect']]
